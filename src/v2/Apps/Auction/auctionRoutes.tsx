...
const AuctionFAQRoute = loadable(
  () =>
    import(
      /* webpackChunkName: "auctionBundle", webpackPrefetch: true */ "./Components/AuctionFAQ"
    ),
  {
...
const ConfirmBidRoute = loadable(
  () =>
    import(
      /* webpackChunkName: "auctionBundle", webpackPrefetch: true */ "./Routes/ConfirmBid"
    ),
  {
...
const RegisterRoute = loadable(
  () =>
    import(
      /* webpackChunkName: "auctionBundle", webpackPrefetch: true */ "./Routes/Register"
    ),
  {
