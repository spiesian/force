...
interface SettingsEditSettingsTwoFactorAppAuthenticatorDisableProps {
  onConfirm: () => void
  onCancel: () => void
  show: boolean
...
export const SettingsEditSettingsTwoFactorAppAuthenticatorDisable: React.FC<SettingsEditSettingsTwoFactorAppAuthenticatorDisableProps> = props => {
