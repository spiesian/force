...
export type purchaseRoutes_PurchaseQueryVariables = {};
export type purchaseRoutes_PurchaseQueryResponse = {
    readonly me: {
        readonly " $fragmentRefs": FragmentRefs<"PurchaseApp_me">;
    } | null;
};
export type purchaseRoutes_PurchaseQuery = {
    readonly response: purchaseRoutes_PurchaseQueryResponse;
    readonly variables: purchaseRoutes_PurchaseQueryVariables;
};
...
(node as any).hash = '9b78e6a494ea88c3da580c9aa5f7ce7f';
export default node;
